...
class AdminEmployeeAcceptedController extends Controller
{
    /**
    ...
    {
        return view('admin.accepted-employee.index',[
            'acceptedTasks' => AcceptedTask::whereIn('status',['accepted', 'on_progress'])->get(),
